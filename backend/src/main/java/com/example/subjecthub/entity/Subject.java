...
public class Subject {
  ...
  @Column(nullable = false) private int creditPoints;

  @Column(nullable = false) private String description;

  @Column(nullable = false) private String minRequirements;

  @Column(nullable = false) private boolean undergrad;

  @Column(nullable = false) private boolean postgrad;

  @Column(nullable = false) private boolean autumn;

  @Column(nullable = false) private boolean spring;

  @Column(nullable = false) private boolean summer;

  @Column private double rating;

  @Column private int numRatings;
